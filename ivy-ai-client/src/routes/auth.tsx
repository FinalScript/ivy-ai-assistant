    ...
    <div className="min-h-screen bg-base-200 flex items-center justify-center p-4">
      <div className="card max-w-sm w-full bg-base-100 shadow-xl">
        <div className="card-body p-6">
              ...
              <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                ...
                <div className="form-control">
                  ...
                  <input
                    type="password"
                    placeholder="••••••"
                    className={`input input-bordered w-full ${loginForm.formState.errors.password ? 'input-error' : ''}`}
                ...
                >
                  ...
                  {isLoading && <span className="loading loading-spinner loading-sm ml-2"></span>}
                </button>
              </form>
              ...
              <form onSubmit={registerForm.handleSubmit(onRegisterSubmit)} className="space-y-3">
                ...
                <div className="form-control">
                  ...
                  <input
                    type="password"
                    placeholder="••••••"
                    className={`input input-bordered w-full ${registerForm.formState.errors.password ? 'input-error' : ''}`}
                ...
                <div className="form-control">
                  ...
                  <input
                    type="password"
                    placeholder="••••••"
                    className={`input input-bordered w-full ${registerForm.formState.errors.confirmPassword ? 'input-error' : ''}`}
          ...
          <button 
            className="btn w-full bg-white hover:bg-gray-100 text-gray-800 border-gray-300"
            disabled={isLoading}
          >
