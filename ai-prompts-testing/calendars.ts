...
TASK:
Extract assessment dates, deadlines, and schedule changes from the provided academic calendar.
...
4. Focus on dates, deadlines, and schedule changes
5. Convert all times to ISO 8601 format with timezone
6. Use local timezone if none specified
7. Set missing values to null
8. Mark any rescheduled classes with is_rescheduled=true
9. Include locations for exams and in-person assessments
